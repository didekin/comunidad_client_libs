...
public interface UsuarioEndPoints {
    ...
    @PUT(USER_WRITE)
    Single<Response<Integer>> modifyUser(@Header(CommonServConstant.ACCEPT_LANGUAGE) String localeToStr,
    ...
    @FormUrlEncoded
    @POST(PASSWORD_SEND)
    Single<Response<Boolean>> passwordSend(@Header(CommonServConstant.ACCEPT_LANGUAGE) String localeToStr, @Field(USER_PARAM) String userName);
}