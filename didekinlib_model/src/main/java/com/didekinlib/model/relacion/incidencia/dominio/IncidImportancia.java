...
import static com.didekinlib.model.relacion.incidencia.dominio.IncidenciaSerialNumber.INCID_IMPORTANCIA;
    ...
    public final static class IncidImportanciaBuilder implements BeanBuilder<IncidImportancia> {
        ...
        public IncidImportancia build()
        {
            ...
            if (incidImportancia.userComu != null
                    && (! incidImportancia.userComu.getEntidad().equals(incidImportancia.incidencia.getComunidad()))){
                throw new IllegalStateException(error_message_bean_building + this.getClass().getName());
            }
